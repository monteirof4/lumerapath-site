...
export default function FreeTrainingForm() {
    ...
    <div className="mx-auto max-w-6xl px-5 py-20 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="rounded-[2rem] border border-navy-900/10 bg-white/70 p-8 shadow-[0_30px_80px_-35px_rgb(15_28_54/0.45)] backdrop-blur-sm">
          ...
          <p className="mt-5 text-lg italic leading-relaxed text-navy-900">
            A practical class to stop postponing what matters to you.
          </p>

          <p className="mt-5 text-lg leading-relaxed text-navy-900">
            You keep telling yourself you&rsquo;ll make time for yourself when things
            calm down. So why does your time keep going to everything and everyone
            else?
          </p>

          <p className="mt-4 text-sm leading-relaxed text-ink-soft">
            Join this complimentary masterclass and discover why what matters to you
            can so easily become the most flexible part of your calendar, and how to
            begin protecting your time without adding more pressure, guilt, or another
